$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'financial/deliver/list',
        datatype: "json",
        colModel: [
...
var vm = new Vue({
    ...
    methods: {
        ...
        excel: function () {
            ...
            vm.showList = true;
            var param = jQuery.param(vm.d);
            excel(baseURL + "financial/deliver/excel", param)
        },
        getCarSourceById: function (id) {
            $.get(baseURL + "financial/deliver/detail/" + id, function (r) {
